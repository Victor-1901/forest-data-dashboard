...
if selected == "Problématique":
    ...
    uploaded_file = 'C:/Users/victo/nouveau_dataframe_mis_a_jour.csv'
    ...
    if graphique_choisi == "Répartition de la Superficie Forestière (%) par Continent en 2023":
        image_path = 'C:/Users/victo/foret_2023/superficie_forestiere_boxplot.png'
        try:
        ...
        st.image('C:/Users/victo/foret_2023/Europe foret.png', caption="Répartition de la Superficie Forestière en Europe")
        if st.checkbox("Afficher l'explication du graphique"):
            st.markdown("""
        ...
        st.image('C:/Users/victo/foret_2023/_France en surbrillance.png', caption="Superficie forestière en France")
        if st.checkbox("Afficher l'explication du graphique"):
            st.markdown("""
...
# Section "Analyse par pays / année 2023"
    ...
    if analyse_graphique_choisi == "Les 10 Pays avec la Plus Grande Superficie Forestière (%) en 2023":
        try:
            st.image('C:/Users/victo/foret_2023/autre graphique 10 pays.png', caption="10 Pays avec le plus de Densité forestière")
            if st.checkbox("Afficher l'explication du graphique"):
                st.markdown("""
    ...
    # Affichage du graphique : "Répartition des Pays Européens avec le Moindre Superficie Forestière en 2023"
        ...
        try:
            st.image('C:/Users/victo/pays_europeens_faibles_forets.png', caption="Pays européens avec faibles forêts")
            if st.checkbox("Afficher l'explication du graphique"):
                st.markdown("""
    ...
    # Affichage du graphique : "Corrélation entre la Densité Forestière (%) et les Terres Agricoles (%) en 2023"
        ...
        try:
            st.image('C:/Users/victo/foret_2023/_Terre agricole (%) et la Superficie forestière (%).png', caption="Corrélation entre la Densité forestière et les Terres agricoles")
            if st.checkbox("Afficher l'explication du graphique"):
                st.markdown("""
    ...
    # Affichage du graphique : "Corrélation entre le Taux de Natalité et la Densité Forestière (%) en 2023"
        ...
        try:
            st.image('C:/Users/victo/foret_2023/fecondite (1).png', caption="Corrélation entre le Taux de natalité et la Densité forestière")
            if st.checkbox("Afficher l'explication du graphique"):
                st.markdown("""
                    Ce graphique de dispersion illustre la relation entre le taux de fécondité (axe vertical) et la superficie forestière (axe horizontal) pour différents pays en 2023. Les points sont colorés en fonction du continent auquel chaque pays appartient, permettant de visualiser les différences régionales.
                    **Analyse des résultats :**
                    1. **Tendance générale :** Le graphique ne montre pas de corrélation directe entre le taux de fécondité et la superficie forestière, ce qui indique que la densité de couverture forestière ne semble pas être directement liée aux taux de natalité.
                    2. **Différences régionales :** En observant les couleurs, on peut noter certaines variations entre continents. Par exemple, certains pays africains (points verts) présentent des taux de fécondité plus élevés avec une couverture forestière variable.
    ...
    # Affichage du graphique : "Corrélation entre le Taux de Population et la Superficie Forestière (%) en 2023"
        ...
        try:
            st.image('C:/Users/victo/foret_2023/Relation_Population_Superficie_Forestière (1).png', caption="Corrélation entre le Taux de population et la Superficie forestière")
            if st.checkbox("Afficher l'explication du graphique"):
                st.markdown("""
    ...
    images_path = {
        'Afrique': 'C:/Users/victo/foret_20_ans/afrique chart (1).png',
        'Amérique du Nord': 'C:/Users/victo/foret_20_ans/AmeriqueNordchart (1).png',
        'Amérique du Sud': 'C:/Users/victo/foret_20_ans/AmeriqueSud-chart (1).png',
        'Asie': 'C:/Users/victo/foret_20_ans/Asie-chart (1).png',
        'Europe': 'C:/Users/victo/foret_20_ans/Europee (1).png',
        'Océanie': 'C:/Users/victo/foret_20_ans/oceanie-chart (1).png'
    }
    ...
    if continent == 'Afrique' and show_explanation:
        ...
        st.markdown("""
            ...
            **Interprétation :**
            - Bien que la tendance générale montre une couverture forestière relativement stable, la persistance des variations souligne la nécessité de maintenir et de renforcer les efforts de gestion des forêts pour garantir une couverture forestière saine.
        """)
...
# Section "Vidéo - Déforestation de la forêt amazonienne"
    ...
    video_path =  "C:/Users/victo/Untitled design (1).mp4"
